 ...
 * 과목클래스에 필요한 멤버 변수/메소드를 생성하세요.
 * 멤버 변수 : 과목명 subjectTitle
 * 			 과목코드 subjectCode
 * 			 교수명 professorName
 * 			 년도 
 * 			 학기 
...
public class Subject {
	...
	public String toString() {
		return "과목 [과목명 : " + subjectTitle + ", 과목코드 : " + subjectCode + ", 담당교수 : "
				+ professorName + ", 시수 : " + subjectTime + ", 학점 : " + subjectPoint + ", 년도 : "
				+ subjectYear + ", 학기 : " + subjectTerm + ", 분류 : " + subjectCategory
				+ ", 시간 : " + subjectSchedule + "]";
	}
