...
<body>
	<div class="box">
        ...
        <form action="<%=request.getContextPath()%>/signup" id="form" method="post">
            ...
            <input type="password" name="pw2" placeholder="비번확인" id="pw2" value=""><br>
            ...
            <input type="text" name="name" placeholder="이름" value="${user.name}"><br>
            <label for="name" id="name-error" class="error"></label><br>
            <input type="text" name="email" placeholder="이메일" value="${user.email}"><br>
            <label for="email" id="email-error" class="error"></label><br>
            <input type="text" name="home" placeholder="홈페이지" value="${user.home}"><br>
