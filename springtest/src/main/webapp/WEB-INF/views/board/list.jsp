...
<div class="container">
  ...
  <table class="table table-dark table-hover">
    ...
    <tbody>
      ...
      <tr>
        <td>${board.num}</td>
        <td><a href="<%=request.getContextPath()%>/board/detail?num=${board.num}&page=${pm.criteria.page}&search=${pm.criteria.search}&type=${pm.criteria.type}" class="title">${board.title}</a></td>
        <td>${board.writer}</td>
